...
plt.savefig('examples/figures/transcendental_composite.png', dpi=150, bbox_inches='tight')
...
plt.savefig('examples/figures/transcendental_trig_product.png', dpi=150, bbox_inches='tight')
